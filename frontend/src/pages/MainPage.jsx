                        ...
                        <div className="w-full md:w-[60%] flex flex-col bg-white">
                          <div className="flex-1 p-6 sm:p-8 space-y-4">
                            <section>
                              ...
                              <p className="text-gray-600 text-sm leading-tight whitespace-pre-wrap bg-gray-50 p-4 rounded-xl border border-gray-100">{(policy.desc || "상세 설명이 제공되지 않았습니다.").replace(/\n\s*\n/g, '\n')}</p>
                            </section>
